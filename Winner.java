...
/**
 * Class used to facilitate storing of winners seperate to an Entry and a normal Member.
 */
public class Winner extends Member implements Comparable<Winner> {
    ...
    /**
     * Constructor used during competition drawing for creating winners.
    ...
    /**
     * Overiding to default compareTo method to sort an Arraylist of Winners by their entryId's
     */
    @Override
    ...
    /**
     * Update the prize associated with this winner. This is called if a winner has won
     * another prize, and will give this winner the better prize, or the one with
     * smaller id if they are the same.
     * @param winningEntry The new winning entry to check if its better and should be updated
